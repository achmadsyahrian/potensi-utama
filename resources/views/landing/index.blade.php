         ...
         <div class="container">
               <div class="row justify-content-center">
                  <div class="col-lg-6 text-center">
                     <h2 data-aos="fade-down">Pendaftaran <span>Mahasiswa Baru</span></h2>
                     <p data-aos="fade-up">Selamat datang di Universitas Potensi Utama! Pendaftaran mahasiswa baru telah dibuka. Bergabunglah dengan kami untuk memulai perjalanan akademis Anda di salah satu perguruan tinggi terbaik di Sumatera Utara.</p>
                     <a data-aos="fade-up" data-aos-delay="200" href="#get-started" class="btn-get-started">Lihat Informasi Pendaftaran</a>
                 </div>                 
               </div>
         </div>
      </div>
