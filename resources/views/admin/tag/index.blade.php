...
@section('content')
                ...
                <div class="card-body border-bottom py-3">
                    <div class="row">
                        <div class="col-6 d-flex align-items-center">
                            <form action="{{ route('admin.tags.index') }}" method="get" class="w-100">
                        ...
                        <div class="col-6 d-flex justify-content-end align-items-center">
                            <a href="{{ route('admin.tags.index') }}" class="btn btn-warning btn-pill">
                            ...
                            @forelse ($data as $item)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="#" 
                                            class="fw-bold text-primary edit-button" 
                                            data-bs-toggle="modal" 
                                            data-bs-target="#modal-edit" 
                                            data-id="{{ $item->id }}" 
                                            data-action="{{ route('admin.tags.update', $item->id) }}"
                                            data-name="{{ $item->name }}"
                                            data-slug="{{ $item->slug }}"
                                            data-description="{{ $item->description }}">
                                            Edit
                                        ...
                                        <a href="#" class="fw-bold text-danger" data-bs-toggle="modal" data-bs-target="#modal-delete" data-id="{{ $item->id }}" data-action="{{ route('admin.tags.destroy', $item->id) }}" data-message="Anda yakin ingin mengghapus tag '{{ $item->name }}'?">Hapus</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
    ...
    {{-- Modal Create --}}
    @include('admin.tag.modal.create')

    {{-- Modal Edit --}}
    @include('admin.tag.modal.edit')

    {{-- Modal Detail --}}
    @include('admin.tag.modal.detail')

    {{-- Modal Delete --}}
    @include('admin.tag.modal.delete')
